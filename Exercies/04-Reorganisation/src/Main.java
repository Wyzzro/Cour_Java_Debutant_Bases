...
public class Main {
    ...
    public static int[] reorderDesc(int[] disorganizeArray) {
        //Exercice 1 : Écrivez le code de cette fonction, dont le fonctionnement voulu vous est cité ci-dessus !
    ...
    public static int[] reorderAsc(int[] arrayDesc) {
        /*
        Exercice 2 : Uniquement après avoir réussi l'exercice 1, écrivez le code de cette fonction dont le 
            fonctionnement voulu vous est cité ci-dessus !
        Difficulté : Moyen
        */ 
    }
